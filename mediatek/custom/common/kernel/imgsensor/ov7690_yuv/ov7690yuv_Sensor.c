...
static void OV7690SetClock(kal_uint32 Clk)
{
 ...
 // OV7690_write_cmos_sensor(0x11, ClkSetting[i][0]);
  OV7690_write_cmos_sensor(0x11, 0X03);
}
...
static void OV7690AeEnable(kal_bool Enable)
{
 ...
 //OV7690_write_cmos_sensor(0x15, OV7690Sensor.Reg15);
  OV7690_write_cmos_sensor(0x15, 0xc4);
}
...
static void OV7690InitialSetting(void)
{
  ...
  /* Clock */
  OV7690_write_cmos_sensor(0x11, 0x03);//0x00-30fps 0x01-15fps
  ...
  OV7690_write_cmos_sensor(0x15, 0xa4);//0x04
  ...
  OV7690_write_cmos_sensor(0xb8, 0x0b);			/*(06-->0b)modify by KeJun 20110914*/														
  ...
  OV7690_write_cmos_sensor(0x26, 0xc4);			/*(92-->c4)modify by KeJun 20110914*/
  
  /* UV adjust */
  OV7690_write_cmos_sensor(0x5A, 0x4A);			/*(74-->4A)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0x5B, 0x9F);			/*(9f-->9F)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0x5C, 0x70);			/*(42-->48)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0x5d, 0x32);			/*(42-->32)modify by KeJun 20110914*/
  
  /* Gamma */
  OV7690_write_cmos_sensor(0xa3, 0x08);			/*(05-->08)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xa4, 0x15);			/*(10-->15)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xa5, 0x24);			/*(25-->24)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xa6, 0x45);			/*(4f-->45)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xa7, 0x55);			/*(5f-->55)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xa8, 0x6a);			/*(6c-->6a)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xa9, 0x78);			/*(78-->78)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xaa, 0x87);			/*(82-->87)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xab, 0x96);			/*(8b-->96)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xac, 0xa3);			/*(92-->a3)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xad, 0xb4);			/*(9f-->b4)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xae, 0xc3);			/*(Ac-->c3)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xaf, 0xd6);			/*(C1-->d6)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xb0, 0xe6);			/*(D5-->e6)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xb1, 0xf2);			/*(E7-->f2)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0xb2, 0x12);			/*(21-->12)modify by KeJun 20110914*/
...
static BOOL OV7690_set_param_banding(UINT16 para)
{
	...
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			OV7690_write_cmos_sensor(0x14, 0x11);
			break;
